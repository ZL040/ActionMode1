package com.example.lenovo.actionmode1;
...
import com.example.hmh.actionmode.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    class MultiChoiceListener implements AbsListView.MultiChoiceModeListener {
        ...
        public void onItemCheckedStateChanged(ActionMode mode, int position, long id, boolean checked) {
            ...
            mode.setTitle("Listview"+(position+1)+" Selected");
            ...
            switch(item.getItemId())
            {
                ...
                case R.id.select:
                    if(!isSellectedAll)
                    {
                        ...
                        if(mDate.size()==0) {
                            mode.setTitle(" No Listview Selected");
                        } else {
                            mode.setTitle(" All Listview Selected");
                        }
                        mPosition.clear();
